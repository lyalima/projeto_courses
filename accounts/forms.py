...
from utils.cpf_validation import cpf_validation
...
class CustomUserCreationForm(UserCreationForm):
    ...
    class Meta:
        ...
        fields = ("full_name", "username", "cpf", "date_of_birth", "email", 
                  "telephone", "zip_code", "address", "number", "neighborhood",
    ...
    def clean_cpf(self):
        ...
        cpf_verification = cpf_validation(cpf)

        if (len(cpf) != 11) or (not cpf_verification):
            raise ValidationError(f"Digite um CPF válido")
